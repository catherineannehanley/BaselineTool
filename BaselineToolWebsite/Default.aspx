            ...
            <br />
               <fieldset>
                   ...
                   <input type="text" maxlength="4" id="startZoom" name="Start" /><br>
                    ...
                    <br>
                   <button type="button" class="btn btn-secondary" onclick="updatexAxis()">Update Chart</button>

                   <button type="button" id="compareCharts" class="btn btn-secondary" onclick="compareChart()">Compare</button>

                   <button type="button" id="exportChart" class="btn btn-secondary">Export Chart</button>
